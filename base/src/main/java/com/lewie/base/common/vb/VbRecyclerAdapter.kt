...
//        loadingCell: VbItemCell = VbDefaultLoadingCell(),
//        callback: () -> Unit = {}
//    ) {
...
//     */
//    fun submitErrorCell(
//        @IntRange(from = 1) pageIndex: Int, errorCell: VbItemCell = VbDefaultErrorCell(),
//        callback: () -> Unit = {}
//    ) {
//        if (pageIndex == 1) {
...
//        emptyCell: VbItemCell = VbDefaultEmptyCell(),
//        callback: () -> Unit = {}
//    ) {
//        when (pageIndex) {
//            1 -> {
